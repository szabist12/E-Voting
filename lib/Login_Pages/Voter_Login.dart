import 'package:app/SignUp_Pages/Voter_SignUp.dart';
...
class VoterLoginPage extends StatefulWidget {
  @override
  _VoterLoginPageState createState() => _VoterLoginPageState();
}
...
class _VoterLoginPageState extends State<VoterLoginPage> {
  ...
  void _submitform() async {
    if (_formKey.currentState!.validate()) {
      apicontroller.loginVoters(c.text, p.text, context);
    }
  }
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => forgetpassword(type: "u",),
                            ),
                          );
                        },
                        child: const Text(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => VoterSignUpPage(title: '')),
                        );
                      },
