...
class _FirstNamePageState extends State<FirstNamePage> {
  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      apicontroller.updateFirstNameVoter(user.Cnic, first_name.text,context);
    }
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      'Edit your first name to consider your vote',
                      style: TextStyle(
                        fontWeight: FontWeight.w500,
                        color: Colors.grey,
                      ),
...
class _LastNamePageState extends State<LastNamePage> {
  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      apicontroller.updateLastNameVoter(user.Cnic, last_name.text,context);
    }
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      'Edit your last name to consider your vote',
                      style: TextStyle(
                        fontWeight: FontWeight.w500,
                        color: Colors.grey,
                      ),
...
class ContactUpdate extends StatefulWidget {
  final Voters user;
  ContactUpdate(this.user);
  @override
  _ContactUpdate createState() => _ContactUpdate(user);
}

class _ContactUpdate extends State<ContactUpdate> {
  final Voters user;
  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      apicontroller.updatePhoneNoVoter(user.Cnic, num.text,context);
    }
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      'Edit your active correct number to consider your vote',
                      style: TextStyle(
                        fontWeight: FontWeight.w500,
                        color: Colors.grey,
                      ),
...
class EmailUpdate extends StatefulWidget {
  final Voters user;
  EmailUpdate(this.user);
  @override
  _EmailUpdate createState() => _EmailUpdate(user);
}

class _EmailUpdate extends State<EmailUpdate> {
  final Voters user;
